public class Main {
    public static void main(String[] args) {
        ...
        double e = 2.8;
        System.out.println("Значение переменной pi c типом double"+e);
        ...
        int classPaper = amountOfPaper / (classA + classB + classC);
        ...
        int bootles = 16;
        int minutes =  2;
        int productivityperMinutes = bootles/ minutes;
        int twentyminutes = 20;
        System.out.println("За" + twentyminutes+"минут машина произвела бутылок" + productivityperMinutes + " штук.");
        int productivityOneDay = minutes * 1440;
